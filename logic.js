...
var initialsEl = document.getElementById('inititals');
...
function getQuestion() {
  ...
  // loop over choices - referenced Khan Academy for help with the loop process
...
function questionClick(event) {
 ...
 setTimeout(function () {
  ...
  //adding else to the if statement, so flash correct feedback will be on page for half a second
  feedbackEl.setAttribute('class', 'feedback correct');
  setTimeout(function () {
    feedbackEl.setAttribute('class', 'feed hide');
  }, 1000);
}
...
function saveHighscore() {
  ...
  if (initials !== '') {
    ...
    /* What would we put inside STRINGIFY? */ 
